    ...
    <div class="confirmation-container">
        ...
        <div style="width: 100%; margin: 1.5rem; display: flex; flex-direction: column; gap: 1rem;">
            <div
                ...
                <div
                    style="display: flex; flex-direction: column; gap: 0.875rem; background-color: white; padding: 1rem;">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 1rem; width: 100%;">
                            <div
                                ...
                                <?php foreach ($services as $service):
                                    $previousTreatmentIndex = array_search(
                                        $service['id'],
                                        array_column($previousTreatments, 'prev_service_id')
                                    );
                                    if ($previousTreatments[$previousTreatmentIndex]['prev_service_id'] == $service['id']):
                                        ?>
                                        <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                                            <label for="rebond"><?php echo $service['name']; ?></label>
                                            <span
                                                style="margin-left: 1rem; font-size: 0.875rem; line-height: 1.25rem;"><?php echo $previousTreatments[$previousTreatmentIndex]['min_time_months']; ?>
                                                month<?php echo $previousTreatments[$previousTreatmentIndex]['min_time_months'] <= 1 ? '' : 's' ?>
                                                minimum time span</span>
                                        </div>
                                ...
                                <div style=" grid-column: span 2 / span 2; margin: 1rem 0;" class="divider"></div>
                                <span
                                    style="grid-column: span 2 / span 2; font-weight: bold; font-size: 1.125rem; line-height: 1.75rem;">Alternative
                                    Treatments</span>
                                <?php
                                        ...
                                        <div style="display: flex; flex-direction: column; gap: 0.75rem;">
                                            ...
                                            <div
                                                ...
                                                <span style="margin-left: 1rem; font-size: 0.75rem; line-height: 1.25rem;">
                                                    Reason:
                                                    <?php echo htmlspecialchars($alternativeTreatments[$service['id']]); ?>
                                                </span>
                                            </div>
                                        </div>
