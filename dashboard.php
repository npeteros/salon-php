                            ...
                            <div class="flex gap-4 items-center">
                                ...
                                <div class="flex flex-col gap-1">
                                    ...
                                    <div class="flex flex-col text-sm text-[#49454F]">
                                        <span>Category • $$ • 1.2 miles away</span>
                                        <span class="w-60 truncate">Supporting line text lorem ipsum dolor sit amet,
                                            consectetur.</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="bg-[#A80011] w-full rounded-xl">
                                ...
                                <tbody class="bg-white text-center">
                                    <tr>
                                        ...
                                        <td>1:00 PM</td>
                                        <td class="px-4 w-36">
                                            <div class="bg-[#9B9B9B] rounded-full text-white py-1">Upcoming</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="flex justify-center py-1">
                                            <img src="https://api.multiavatar.com/Dogecoin.png" alt="staff"
                                                class="size-8">
                                        </td>
                                        <td>Service 1</td>
                                        <td>9/27/24</td>
                                        <td>1:00 PM</td>
                                        <td class="px-4 w-36">
                                            <div class="bg-[#18E32C] rounded-full text-white py-1">Completed</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="flex justify-center py-1">
                                            <img src="https://api.multiavatar.com/Lucius%20Tattaglia.png" alt="staff"
                                                class="size-8">
                                        </td>
                                        <td>Service 1</td>
                                        <td>9/27/24</td>
