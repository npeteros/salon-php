        ...
        <div class="w-full m-6">
            <div class="bg-white dark:bg-neutral-700 flex flex-col w-full gap-4 p-4 rounded-2xl">
                <ol class="items-center w-full justify-between space-y-4 sm:flex sm:space-y-0 rtl:space-x-reverse">
                    ...
                    <li class="flex items-center text-gray-500 dark:text-gray-200 space-x-2.5 rtl:space-x-reverse sm:after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-200 after:border-1 after:hidden sm:after:inline-block after:mx-6 xl:after:mx-10 dark:after:border-gray-200 w-full">
                        <span
                            class="flex items-center justify-center w-8 h-8 border border-gray-500 rounded-full shrink-0 dark:border-gray-400">
                            3
                        </span>
                    ...
                    <form method="post" action="./book-service.php" class="flex flex-col gap-4 w-full">
                        <div class="flex gap-4 w-full">
                            <div class="flex flex-col gap-2 w-1/2">
                                <label for="name" class="font-bold dark:text-gray-200">Confirm Date</label>
                            ...
                            <div class="flex flex-col gap-2 w-1/2">
                                <label for="name" class="font-bold dark:text-gray-200">Confirm Time</label>
