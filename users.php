                    ...
                    <div style="position: relative;">
                        ...
                        <div id="dropdown"
                            ...
                            <div style="padding-top: 0.5rem; padding-bottom: 0.5rem; font-size: 0.875rem; line-height: 1.25rem; color: #374151;"
                                ...
                                <button type="button"
                                    class="filterUsers" data-id="all">All</button>
                                <button type="button"
                                    class="filterUsers" data-id="user">User</button>
                                <button type="button"
                                    class="filterUsers" data-id="stylist">Stylist</button>
                                <button type="button"
                                    class="filterUsers" data-id="manager">Manager</button>
                                <button type="button"
                                    class="filterUsers" data-id="owner">Owner</button>
                            </div>
                        </div>
                    </div>
                </div>
