...
$selectedTreatment = $consultation ? getTreatmentById($consultation['treatment_id']) : [];
$suitable = $consultation ? $consultation['status'] == 'Suitable' ? true : false : false;
