    ...
    <div class="main-container">
        <div class="modal" id="filterModal">
            <div class="modal-content">
                ...
                <form id="filterServices">
                    <label class="modal-label" for="name">Name</label>
                    <input type="text" id="name" class="modal-input" placeholder="Enter service name">

                    <label class="modal-label" for="description">Description</label>
                    <input type="text" id="description" class="modal-input" placeholder="Enter description">

                    <label class="modal-label" for="price">Price</label>
                    <input type="number" id="price" class="modal-input" placeholder="Enter price" step="0.01">
